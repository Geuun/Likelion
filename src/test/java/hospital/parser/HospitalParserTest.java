...
class HospitalParserTest {
    ...
    void parseId() {
        ...
        //subdivision
        Assertions.assertEquals("종합의원",hospital.getSubdivision());
    }
}